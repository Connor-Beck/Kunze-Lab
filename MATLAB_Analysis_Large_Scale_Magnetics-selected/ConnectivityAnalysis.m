function [dF,Spikes,ROI,ROIbases,corr]=ConnectivityAnalysis(filename,MinValROI,std_threshold,static_threshold)
...
figure('Name',filename); Cell_Map_Dice(AverageImage,Connected_ROI,ROIbases);
