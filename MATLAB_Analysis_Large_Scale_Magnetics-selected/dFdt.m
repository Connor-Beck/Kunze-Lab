function dFdt = location_analysis_dFdt(ROI, Image_Stack,num_images,Background_Noise)
...
%     Region = cell2mat(ROI{i});
    ...
    for l = 1:num_images-1
        dFdt(i,l) = (AvgIntensityRegion(i,l+1)-AvgIntensityRegion(i,l))/Background_Noise(l,1);
    end
end
delete(H)
